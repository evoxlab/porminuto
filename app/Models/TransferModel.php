...
class TransferModel extends Model{
    ...
    protected $allowedFields = ['id', 'store_leave_id', 'store_arrive_id', 'date','qty','unit_cost','total_costo', 'user_id', 'created_at', 'updated_at'];
    ...
    public function get_all(){
        $obj_result =  $this->db->query("SELECT a1.id, a1.qty,a1.date,a1.unit_cost,a1.total_costo,m.name, s.name AS departure, s2.name AS arrive, CONCAT(u.name,' ', u.lastname) AS user
                                        FROM transfer AS a1
