...
class Concept_ticketsModel extends Model{

    

    protected $table      = 'concept_tickets';
    ...
    protected $allowedFields = ['id', 'title', 'date', 'active', 'created_at', 'updated_at'];
    ...
    public function get_all(){
        ...
        $obj_result =  $this->db->query("SELECT `id`, `title` FROM (`concept_tickets`)");
    ...
    public function get_all_data(){
        ...
        $obj_result =  $this->db->query("SELECT * FROM (`concept_tickets`)");
    ...
    public function get_all_data_by_id($id){
        ...
        $obj_result =  $this->db->query("SELECT * FROM (`concept_tickets`) WHERE id = $id");
    ...
    public function insertar($data){
        ...
        $query = $this->db->table('concept_tickets');
    ...
    public function eliminar($id){
        ...
        return $this->db->query("DELETE FROM concept_tickets WHERE id = $id");
