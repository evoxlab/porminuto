                           ...
                           <div class="col-sm-12">
                              <div class="card">
                                 <div class="card-header">
                                    ...
                                    <button class="btn btn-secondary" type="button" onclick="new_banco();"><span><span class="pcoded-micon"><i class="fa fa-plus" aria-hidden="true"></i></span> Nuevo</span></button>
                                 </div>
