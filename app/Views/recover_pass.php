               ...
               <div class="prefix-20 grid-60 prefix-20 tablet-grid-60 tablet-prefix-20 mobile-grid-100">
                  <div class="comments-area clearfix">
                     <div id="respond" class="comment-respond" style="text-align: center;">
                        <form name="form-login" action="javascript:void(0);" onsubmit="validate_captcha(2);" method="post" enctype="multipart/form-data" class="account-form">
                           <p class="comment-form-author">
                              <h2 data-title="<?php echo lang('Global.recuperar_contrasena'); ?>" class="section-title   ut-flowtyped ut-title-loaded" style="font-size: 45px; line-height: 88px !important;">
								<span><?php echo lang('Global.recuperar_contrasena'); ?></span>
							</h2>
                           </p>
                           <p class="comment-form-author">
                              <input name="username" id="username" type="text" required='required' placeholder="Ingrese usuario" />
                           </p>
                           <p class="form-submit">
                              <button type="submit" id="submit" class="btn btn-block" style="width: 100%;border-radius: 5px;font-size: 16px;"><b><?php echo lang('Global.enviar_contrasena'); ?></b></button>
                              <p class="comment-form-author">
                                 <a href="<?php echo site_url()."iniciar-sesion";?>" style="float: right;">Iniciar Sesión</a>
                              </p>
                           </p>
                        </form>
                     </div>
