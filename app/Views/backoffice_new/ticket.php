...
<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
	...
	<div class="d-flex flex-column flex-root">
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
								...
								<div class="card-rounded bg-light d-flex flex-stack flex-wrap p-5">
									<ul class="nav flex-wrap border-transparent fw-bold">
										<li class="nav-item my-1">
											<!-- <a class="fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase active-orange btn btn-primary" href="<?php echo site_url() . BACKOFFICE . "/ticket"; ?>"><?php echo lang('Global.ticket'); ?></a> -->
										</li>
									</ul>
							...
							<div class="card-body">
								<div class="d-flex flex-column flex-xl-row p-7">
									<div class="flex-lg-row-fluid me-xl-15 mb-20 mb-xl-0">
										<div class="mb-0">
											<h1 class="text-dark mb-10"><?php echo lang('Global.listado_tickets'); ?></h1>
											<?php
											if (count($obj_ticket) > 0) {
												foreach ($obj_ticket as $key => $value) { ?>
													<div class="d-flex mb-10">
														...
														<div class="d-flex flex-column">
															<div class="d-flex align-items-center mb-2">
																<a href="<?php echo site_url() . BACKOFFICE . "/ticket/" . $value->id; ?>" class="text-dark text-hover-primary fs-4 me-3 fw-semibold"><?php echo $value->title; ?></a>
																<span class="badge badge-light my-1"><?php echo formato_fecha_dia_mes_anio_abrev($value->date); ?></span>
															</div>
															<span class="text-muted fw-semibold fs-6"><?php echo corta_texto($value->content, 200); ?></span>
														</div>
													</div>
												<?php }
											} else { ?>
												<img src="<?php echo site_url() . "assets/metronic8/media/illustrations/sketchy-1/20.png" ?>" alt="Imagen" class="mw-200 mh-225px mh-lg-375px mb-lg-n12">
											<?php } ?>
										</div>
									</div>
				...
				<div class="modal fade" id="kt_modal_new_ticket" tabindex="-1" aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered mw-750px">
						<div class="modal-content rounded bg-mn-dark">
							...
							<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
								<form name="ticket-form" enctype="multipart/form-data" method="post" action="javascript:void(0);" onsubmit="new_ticket();">
									<div class="mb-13 text-center">
										<h1 class="mb-3 text-mn-dark"><?php echo lang('Global.crear_ticket'); ?></h1>
										<div class="fw-semibold fs-5 text-mn-dark"><?php echo lang('Global.si_necesita_informacion'); ?></div>
									</div>
									<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
										<label class="d-flex align-items-center fs-6 fw-semibold mb-2 text-mn-dark">
											<span class="required text-mn-dark"><?php echo lang('Global.asunto'); ?></span>
										</label>
										<select name="subject" id="subject" class="form-select form-select-solid" required>
											<option value="" data-select2-id="select2-data-12-icnj" class="text-mn-dark"><?php echo lang('Global.seleccionar_asunto'); ?></option>
											<?php
									...
									<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
										...
										<textarea class="form-control form-control-solid form-ticket" rows="4" name="content" id="content" placeholder="<?php echo lang('Global.escribala_descripcion'); ?>" required></textarea>
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
									<div class="row mb-6">
										...
										<div class="col-lg-12">
											<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('<?php echo site_url() . "assets/metronic8/media/svg/avatars/blank.svg" ?>')">
												...
												<label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="<?php echo lang('Global.seleccionar_imagen'); ?>">
													...
													<input type="file" name="image_file" accept="*" />
												</label>
		...
		<script src='<?php echo site_url() . 'assets/backoffice/js/ticket_new.js?123'; ?>'></script>
