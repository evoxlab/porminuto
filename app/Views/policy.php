   ...
   <section class="pageheader-section" style="background-image: url(<?php echo site_url() . "assets/front/img/bg.jpg"; ?>);">
      <div class="container">
         <div class="section-wrapper text-center">
            <h2 class="pageheader-title">Política de Privacidad</h2>
         ...
         <div class="shop__wrapper">
            <div class="product__single">
               <div class="row gx-4 gy-5">
                  <div class="col-md-12">
                     <p>Política de Privacidad establece los términos en que Mundo Network usa y protege la información que es proporcionada por sus usuarios al momento de utilizar su sitio web. Esta compañía está comprometida con la seguridad de los datos de sus usuarios. Cuando le pedimos llenar los campos de información personal con la cual usted pueda ser identificado, lo hacemos asegurando que sólo se empleará de acuerdo con los términos de este documento. Sin embargo esta Política de Privacidad puede cambiar con el tiempo o ser actualizada por lo que le recomendamos y enfatizamos revisar continuamente esta página para asegurarse que está de acuerdo con dichos cambios.</p>
                     ...
                     <p>Mundo Network se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.</p>
                  </div>
