...
class Cart
{
     ...
     * @return float
     */
    public function point($decimals = null, $decimalPoint = null, $thousandSeperator = null)
    {
        $content = $this->getContent();

        $point = $content->reduce(function ($point, CartItem $cartItem) {
            return $point + ($cartItem->qty * $cartItem->options->point);
        }, 0);

        return CartItem::numberFormat($point, $decimals, $decimalPoint, $thousandSeperator);
    }
